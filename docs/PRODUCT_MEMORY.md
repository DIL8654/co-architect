...
The application persists completed analysis snapshots and agent trace data so the UI can show the reasoning flow without re-running Azure Foundry on every read.
