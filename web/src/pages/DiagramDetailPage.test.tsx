      ...
      agentTrace: [
        {
          ...
          highlights: [],
          grounding: { frameworkRefs: [], standardRefs: [], principleRefs: [], tradeoffRefs: [], historyRefs: [], citationRefs: [] },
          usedFoundry: false,
      ...
      missingControls: [
        {
          ...
          grounding: { frameworkRefs: ['OwaspAsvs'], standardRefs: ['ISO 27001'], principleRefs: ['Security'], tradeoffRefs: [], historyRefs: [], citationRefs: [] },
        },
      ],
      recommendations: [
        {
      ...
      tradeoffs: [
        {
          ...
          pros: ['More control'],
          cons: ['More setup'],
          grounding: { frameworkRefs: [], standardRefs: ['SOC 2'], principleRefs: [], tradeoffRefs: ['Security vs usability'], historyRefs: [], citationRefs: [] },
        },
      ],
